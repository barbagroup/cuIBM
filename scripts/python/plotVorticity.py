...
parser.add_argument("--bl-x", type=float, dest="bl_x", help="x-coordinate of the bottom left of the plot region", default=-2)
parser.add_argument("--bl-y", type=float, dest="bl_y", help="y-coordinate of the bottom left of the plot region", default=-3)
parser.add_argument("--tr-x", type=float, dest="tr_x", help="x-coordinate of the top right of the plot region", default=4)
parser.add_argument("--tr-y", type=float, dest="tr_y", help="y-coordinate of the top right of the plot region", default=3)
...
folder = args.folder
nt, startStep, nsave = rd.readSimulationParameters(folder)
